...
# Model Parameters
A = [0.01, 1] # frequency factor (Volmer, Heyrovsky)
k = [A[0]*cmax, A[1]*cmax] # forward rate constants (Volmer, Heyrovsky)
beta = [0.5, 0.5] # thingy
G_Hads = F * -0.15      # change in Gibbs free energy due to Hydrogen adsorption (this is the actual value itself: other negative signs are taken care of elsewhere)
...
total_rate_vals =    (rate_vals[:,0] + rate_vals[:,1]) * -F     # adds each corresponding Volmer and Heyrovsky rate value
