...
soln = solve_ivp(sitebal, duration, theta0, t_eval = t, method = "RK45")
...
plt.figure(figsize=(8, 6))
plt.plot(t[1:], rate_forward[1:], label=r'$r_0$ (rate of hydrogen adsorption)', color='green')
plt.plot(t[1:], rate_backward[1:], label=r'$r_1$ (rate of hydrogen desorption)', color='blue')
plt.xlabel('Time (s)')
