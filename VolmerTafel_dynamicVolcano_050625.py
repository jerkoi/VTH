...
if do_dynamic_ghad:
    ...
    dGmin_eV = -0.06
    dGmax_eV = 0.06
    dGmin = dGmin_eV * AvoNum * conversion_factor
    dGmax = dGmax_eV * AvoNum * conversion_factor
    ...
    GHad_t_eV = GHad_t_J / (AvoNum * conversion_factor)
...
if do_static_volcano:
    ...
    GHad_eV_list = np.linspace(-0.06, 0.06, 25)
