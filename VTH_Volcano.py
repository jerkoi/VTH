...
if do_dynamic_ghad:
    ...
    #equilibrium potential function, Pseudo-steady state assumption model
    ...
    #site balance to account for charge transfer differences during reaction steps
    def sitebal(t, theta):
    ...
    #integral solving function, solves for new coverage for each time step
